...
This file records the differences introduced when `The Flashback` was extracted into standalone output files and then normalized to match the rewrite standard used for `Prelude`.

## Current State

- `the-flashback-original.md` preserves the archival extract from the working manuscript
- `the-flashback-edited.md` is the standalone editorial version
- `the-flashback.md` matches the current edited build source used for PDF generation
